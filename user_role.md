...
`"user".role` เป็น FK ชี้มาที่ตารางนี้ → ใส่บทบาทนอกเหนือจาก 3 ตัวนี้ไม่ได้ตั้งแต่ระดับฐานข้อมูล
...
- แถวใน `"user"` ถูกสร้าง/อัปเดตให้อัตโนมัติตอนล็อกอิน โดยตั้ง role เป็น `province`
